...
fs.writeFileSync(path.join(fixturesDir, 'sample.pdf'), pdf)
fs.writeFileSync(path.join(fixturesDir, 'sample.png'), png)
fs.writeFileSync(path.join(fixturesDir, 'sample.jpg'), jpg)
